...
from pages import index, predictions, history, logdata
...
navbar = dbc.NavbarSimple(
    brand='PAP: Puppy Activity Predictor (Sora)',
    brand_href='/', 
    children=[
        ...
        dbc.Col(
            html.P(
                [
                    ...
                    html.A(html.I(className='fab fa-youtube mr-1'), href='https://www.youtube.com/channel/UCoGQ3-gmORbenoesFGLsvtA/'),
                    html.A(html.I(className='fab fa-instagram mr-1'), href='https://www.instagram.com/sora_the_morkie/'),
...
def display_page(pathname):
    ...
    elif pathname == '/logdata':
        return logdata.layout
    else:
