...
interval = dcc.Interval(
            id='graph-update',
            interval=1*23000, # in milliseconds
            n_intervals=0
        )
...
column1 = dbc.Col(
    [
        ...
        dcc.Markdown(
            ...
            Percentages are probabilities of each activity *(20 seconds to update)*
            
            *Using Google's BiqQuery and AutoML*
...
def update_graph(input_data):
    ...
    s=get_predictions()
    s= s.sort_values(by='Prob', ascending=False)
    s= pd.merge(s, colors)
    #print(s)
